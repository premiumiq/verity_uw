...
class DecisionsWriter:
    ...
    async def log_decision(self, decision: DecisionLogCreate) -> dict:
        ...
        params = {
            ...
            "workflow_run_id": str(decision.workflow_run_id) if decision.workflow_run_id else None,
            "execution_run_id": str(decision.execution_run_id) if decision.execution_run_id else None,
            ...
            "redaction_applied": json.dumps(decision.redaction_applied) if decision.redaction_applied else None,
        }
